...
export const mockContacts: Contact[] = [
  ...
  },
  {
    ...
    avatar: 'MK',
    lastMessage: 'When will the product arrive?',
  ...
  },
  {
    ...
    avatar: 'LI',
    lastMessage: 'There is an issue with my order',
  ...
  },
  {
    id: 'contact-7',
    name: 'Youssef Adel',
    phone: '+20 777 888 9900',
    avatar: 'YA',
    lastMessage: 'Customer is very satisfied',
    lastMessageTime: 'Yesterday',
  },
  {
    id: 'contact-8',
    name: 'Salma Fathy',
    phone: '+20 666 555 4433',
    avatar: 'SF',
...
export const mockConversations: Conversation[] = [
  ...
  },
  {
    ...
    contactPhone: '+20 987 654 3210',
    channelType: 'whatsapp',
    agentId: 'agent-2',
    agentName: 'Mohamed Hassan',
    status: 'resolved',
    lastMessage: 'Thank you for your help',
    lastMessageTime: '15 min ago',
    messageCount: 12,
  ...
  },
  {
    id: 'conv-3',
    contactId: 'contact-3',
    contactName: 'Mohammed Karim',
    contactPhone: '+20 555 123 4567',
    channelType: 'whatsapp',
    agentId: 'agent-3',
    agentName: 'Layla Ibrahim',
    status: 'pending',
    lastMessage: 'When will the product arrive?',
    lastMessageTime: '1 hour ago',
    messageCount: 5,
  ...
  },
  {
    id: 'conv-5',
    contactId: 'contact-5',
    contactName: 'Omar Sayed',
    contactPhone: '+20 111 222 3344',
    channelType: 'whatsapp',
    agentId: 'agent-2',
    agentName: 'Mohamed Hassan',
    status: 'resolved',
...
export const mockMessages: Message[] = [
  {
    id: 'msg-1',
    sender: 'customer',
    content: 'Hi, I would like to ask about my order',
    timestamp: '10:30 AM',
  },
  {
    id: 'msg-2',
    sender: 'agent',
    content: 'Hello! Of course, what is your order number?',
    timestamp: '10:32 AM',
    agentName: 'Sarah Ahmed',
    status: 'read',
  },
  ...
  },
  {
    id: 'msg-4',
    sender: 'agent',
    content: 'Thank you! Let me check your order details...',
    timestamp: '10:34 AM',
    agentName: 'Sarah Ahmed',
    status: 'read',
  },
  {
    id: 'msg-5',
    sender: 'agent',
    content: 'Your order is currently being shipped and is expected to arrive within 2-3 business days.',
    timestamp: '10:35 AM',
    agentName: 'Sarah Ahmed',
    status: 'read',
  },
